     ...
     public override void OnInspectorGUI()
    {
      ...
      switch (_toolbarTab)
      {
        case 0:
          ...
          EditorGUILayout.PropertyField(_settings_canBeRotated, new GUIContent("Can be rotated", "If disabled, the object can't be rotated. Can be used to temporarily disable rotation."));
          break;
        case 1:
          GUILayout.Space(EditorGUIUtility.singleLineHeight / 2);
          ...
          GUI.enabled = false;
          EditorGUILayout.PropertyField(_details_rotatingWith, new GUIContent("Rotating with", "The controller that is currently rotating this object."));
          GUI.enabled = true;
          break;
      }
    }
